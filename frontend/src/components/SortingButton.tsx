...
const SortingButton = ({
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="w-1/3 transform cursor-pointer rounded-lg border border-gray-400 px-4 py-2.5 text-xs text-gray-500 transition duration-150 hover:bg-black hover:text-white active:scale-95"
    >
